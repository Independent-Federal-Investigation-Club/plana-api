...
# Add image metadata
LABEL org.opencontainers.image.description="plana-api: The backend api that powered Project Plana." \
      org.opencontainers.image.source="https://github.com/Independent-Federal-Investigation-Club/plana-api" \
